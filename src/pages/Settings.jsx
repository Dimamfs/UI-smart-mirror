    ...
    switch (app.id) {
      ...
      case 'spotify': {
        ...
        return (
          <div className="space-y-4">
            {/* Status card */}
            <div className="rounded-lg border border-gray-700/60 bg-gray-800/60 px-4 py-4 space-y-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-100">Spotify</span>
              </div>
            ...
            <div className="rounded-lg border border-white/10 bg-white/5 px-4 py-3 space-y-1">
              <div className="text-sm font-medium text-gray-200">Managed from mobile app</div>
              <div className="text-sm text-gray-400">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                disabled={!isEnabled}
                style={{
                  background: `linear-gradient(to right, #3b82f6 0%, #3b82f6 ${getFillPercent(getAppSetting('handtracking', 'clickPinchMaxMs', 400), 150, 700)}%, #374151 ${getFillPercent(getAppSetting('handtracking', 'clickPinchMaxMs', 400), 150, 700)}%, #374151 100%)`
                }}
              />
              <div className="flex justify-between text-xs text-gray-400 mt-1">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 shadow-lg shadow-black/20">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Enter this ID in the mobile app → open a profile → tap "Show on Mirror".
              </p>
            </div>
            ...
            {usersState.profiles.length > 0 ? (
              <div>
                <p className="text-sm text-gray-300 mb-3 font-medium">Active on Mirror</p>
                    ...
                    return (
                      ...
                      >
                        <div className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 ${
                          isActive ? 'bg-[var(--mirror-accent-color,#38bdf8)] text-gray-900' : 'bg-gray-600 text-gray-200'
                        }`}>
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-xs text-gray-400 truncate">
                            {profile.source === 'phone' ? 'From mobile app' : profile.gmailConnected ? profile.gmailEmail || 'Gmail connected' : 'Local'}
                          </div>
                        </div>
                        {isActive && (
